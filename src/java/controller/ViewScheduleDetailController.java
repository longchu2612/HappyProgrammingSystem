 ...
 * @author asus
 */
public class ViewScheduleDetailController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ViewScheduleDetailController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ViewScheduleDetailController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        int month = scheduleDAO.getScheduleByScheduleId(scheduleId).getMonth();
        SlotMenteeDAO slotMenteeDAO = new SlotMenteeDAO();
        List<SlotMentee> slots = slotMenteeDAO.getAllSlotMenteeByDates(scheduleId, firstDayOfWeek_2.toString(), firstDayOfWeek_2.plusDays(6).toString());
        ...
        request.setAttribute("slotMentees", slots);
        request.setAttribute("month", String.valueOf(month));
            
        request.getRequestDispatcher("schedule-detail.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("update_week")) { 
            ...
            SlotMenteeDAO slotMenteeDAO = new SlotMenteeDAO();
            List<SlotMentee> slots = new ArrayList<>();
            ScheduleDAO scheduleDAO = new ScheduleDAO();
            String firstDay = firstDayOfWeek.toString();
            String endDay = firstDayOfWeek.plusDays(6).toString();
            slots = slotMenteeDAO.getAllSlotMenteeByDates(Integer.parseInt(schedule_id), firstDay, endDay);
