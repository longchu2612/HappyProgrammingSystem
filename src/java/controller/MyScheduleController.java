...
public class MyScheduleController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet MyScheduleController</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet MyScheduleController at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        String month = request.getParameter("month");
        ...
        Schedule schedule = scheduleDAO.getLastestSchedule(account.getAccount_id());
        if(schedule == null) { 
            String[] weekDates_2 = new String[0];
            String message = "You don't have any teaching schedule yet";
        ...
        List<Slot> slots = scheduleDAO.getAllSlotByDates(scheduleId, firstDayOfWeek_2.toString(), firstDayOfWeek_2.plusDays(6).toString());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (action.equals("update_week")) {
            ...
            slots = scheduleDAO.getAllSlotByDates(scheduleId, firstDay, endDay);
