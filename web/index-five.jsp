<%-- 
    Document   : index-five
    Created on : May 25, 2024, 4:19:55 PM
    Author     : luutu
--%>
        ...
        <div class="main-wrapper">
                            ...
                            <ul class="nav header-navbar-rht">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-end">
                                        ...
                                        <a class="dropdown-item" href="ViewProfile?id=${sessionScope.account.account_id}">Profile</a>
                    ...
                    <div class="instructor-four-face aos " data-aos="fade-up">
                        <div class="row">
                            <div class="col-lg-3 col-md-6">
                                <div class="large-team">
                                    <div class="student-img">
                                        <a href="profile.html"><img src="assets/img/user/user26.png" alt></a>
                                    ...
                                    <div class="team-name">
                                        <h4>
                                            <a href="profile.html">Jack Wilson</a>
                                        </h4>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="large-team">
                                    <div class="student-img">
                                        <a href="profile.html"><img src="assets/img/user/user27.png" alt></a>
                                        <div class="rating-student-four">
                                            <div class="expert-student">
                                                <ul class="student-view-four">
                                                    <li><i class="fas fa-users"></i></li>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="large-team">
                                    <div class="student-img">
                                        <a href="profile.html"><img src="assets/img/user/user28.png" alt></a>
                                        <div class="rating-student-four">
                                            <div class="expert-student">
                                                <ul class="student-view-four">
                                                    <li><i class="fas fa-users"></i></li>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="large-team">
                                    <div class="student-img">
                                        <img src="assets/img/user/user29.png" alt>
                                        <div class="rating-student-four">
                                            <div class="expert-student">
                                                <ul class="student-view-four">
                                                    <li><i class="fas fa-users"></i></li>
            ...
            <section class="testimonial-four">
                <div class="container">
                    ...
                    <div class="testimonial-bg-left">
                        <img src="assets/img/testi-bg-5.png" alt>
                    </div>
                    <div class="testimonial-bg-right">
                        <img src="assets/img/testi-bg-6.png" alt>
                    </div>
                    <div class="testimonial-bg-top">
                        <img src="assets/img/testi-bg-7.png" alt>
                    </div>
                            ...
                            <div class="testimonial-all d-flex justify-content-center">
                                <div class="testimonial-two-head text-center align-items-center d-flex">
                                    <div class="testimonial-four-saying ">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cursus nibh mauris, nec turpis orci lectus maecenas. Suspendisse sed magna eget nibh in turpis. Consequat duis diam lacus arcu. Faucibus venenatis felis id augue sit cursus pellentesque enim Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                        <div class="four-testimonial-founder">
                                            <div class="fount-about-img">
                            ...
                            <div class="testimonial-all d-flex justify-content-center">
                                <div class="testimonial-two-head text-center align-items-center d-flex">
                                    <div class="testimonial-four-saying ">
                                        ...
                                        <p>Donec a sem pharetra, ultricies ipsum id, hendrerit metus. Proin libero dui, scelerisque nec purus ac, malesuada fermentum elit. Nunc pellentesque blandit gravida. Nullam convallis, magna eu vulputate fermentum, nulla risus dignissim mi, eu pulvinar sem ex vel nulla.</p>
                                        <div class="four-testimonial-founder">
                                            <div class="fount-about-img">
                                                <img src="assets/img/user/user20.png" alt>
                                            </div>
