<%-- 
    Document   : profile_setting_mentee
    Created on : May 22, 2024, 9:39:18 PM
    Author     : luutu
--%>
...
<%
    ...
    Account account = accountDAO.getAccPf(accountId);
                    ...
                    <nav class="navbar navbar-expand-lg header-nav">
                        ...
                        <div class="main-menu-wrapper">
                            <div class="menu-header">
                                <a href="index-five.jsp" class="menu-logo">
                            ...
                            <ul class="main-nav">
                                ...
                                <li class="has-submenu active">
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li class="active"><a href="profile-settings-mentee.html">Profile Settings</a></li>
                            ...
                            <div class="profile-sidebar">
                                <div class="user-widget">
                                    ...
                                    <div class="user-info-cont">
                                        <h4 class="usr-name">${account.fullname}</h4>
                                    </div>
                                </div>
                                        ...
                                        <div class="row form-row">
                                            ...
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="accountname" value="${account.account_name}">
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="cal-icon">
                                                        <input type="text" class="form-control" name="dob"  value="${account.dateOfBirth}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control select" name="sex">
                                                        <option  value="false" ${account.sex== false ? 'selected' : ''}>Female</option>
                                                        <option  value="true" ${account.sex== true ? 'selected' : ''}>Male</option>
                                                    </select>
                                                </div>
                                            </div>        
                                            <div class="col-12 col-md-6">
                                                <div class="form-group">
                                                    <label>Mobile</label>
                                                    <input type="text" value="${account.phone}" name="phone" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="form-group">
